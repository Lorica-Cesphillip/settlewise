            ...
            <table class = "table-auto border-b-2">
                ...
                <tbody>
                    ...
                    <tr class = "border-b-2">
                        ...
                        <td class = " w-max h-[45px] p-3 justify-start">{{$employee->divisions->abbreviation}}-{{str_pad($employee->employee_number, 4, '0', STR_PAD_LEFT)}}</td>
                        <td class = " w-max h-[45px] p-3 justify-start">{{$employee->fname}} {{$employee->mname}} {{$employee->lname}} </td>
                        ...
                        <td class = " w-max h-[45px] p-3 justify-start">{{$employee->position}}</td>
                        <td class = " w-max h-[45px] p-3 justify-start">{{$employee->contact_nos}}</td>
                        <td class = " w-max h-[45px] p-3 justify-start">{{$employee->email}}</td>
                        <td class = " w-max h-[45px] p-3 justify-start">
