        ...
        <div class="w-[1489px] h-[784px] left-0 top-[168px] absolute">
            <table class = "table-fixed">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class = "p-1 justify-start border-b-2 w-[173px] h-[50px]">{{$employee->divisions->abbreviation}}-{{str_pad($employee->employee_number, 4, '0', STR_PAD_LEFT)}}</td>
                        <td class = "p-1 justify-start border-b-2 w-[200px] h-[50px]">{{$employee->fname}} {{$employee->mname}} {{$employee->lname}}</td>
                        <td class = "p-1 justify-start border-b-2 w-[200px] h-[50px]">{{$employee->divisions->division_name}}</td>
                        <td class = "p-1 justify-start border-b-2 w-[200px] h-[50px]">{{$employee->position}}</td>
                        <td class = "p-1 justify-start border-b-2 w-[200px] h-[50px]">{{$employee->contact_nos}}</td>
                        <td class = "p-1 justify-start border-b-2 w-[200px] h-[50px]">{{$employee->email}}</td>
                        <td class = "p-1 justify-center border-b-2 w-[138px] h-[50px]">
                            <div class="h-6 px-3 py-0.5 bg-[#ffece5] rounded-xl flex-col justify-center items-center gap-2 inline-flex">
                                <div class="justify-center items-center gap-0.5 inline-flex">
                                    <div class="text-center text-[#ad3306] text-sm font-medium leading-tight">{{$employee->emp_status == 1 ? 'In Service' : 'Archived' }}</div>
                                </div>
                            </div>
                        </td>
