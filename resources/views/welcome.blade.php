            ...
            <div class="w-[1200px] h-[800px] relative">
                <div class="w-[1200px] h-[800px] left-0 top-0 absolute bg-white">
                    <div class="w-[1005px] h-[699px] left-[97px] top-[51px] absolute">
                        ...
                        <div class="w-[965.14px] left-[19px] top-[392px] absolute text-center text-black text-base font-normal leading-[25px]">
                            APHSO commits to archieve an inclusive and sustainable development of communicaties/ settlements by planning, implementing and supervising the Human Settlement (HS) program in Albay upholding ethics of governance - transparency, accountability, participation, non-dicriminition, responsiveness and poverty allevation. <br/><br/>“People’s welfare is Our primary concern.”
                        </div>
                        <div class="w-[968px] h-[23px] left-[21px] top-[552px] absolute text-center text-black text-xl font-bold leading-normal">Vision</div>
                        <div class="w-[968px] h-[23px] left-[21px] top-[586px] absolute text-center text-black text-base font-normal leading-normal">
                            Humanized Settlement Communication
                        </div>
                        <div class="w-[1005px] h-[57px] left-0 top-[256px] absolute text-center text-black text-5xl font-bold leading-[30px]">
                            DOCUMENT MANAGEMENT SYSTEM
                        </div>
                        <div class="w-[1005px] h-[30px] left-0 top-[226px] absolute text-center text-black text-2xl font-normal leading-[30px]">
                            Welcome to the Albay Provincial Human Settlement Office
                        </div>
