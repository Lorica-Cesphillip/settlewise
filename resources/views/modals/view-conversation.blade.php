...
<!-- Chat Modal -->
<x-modal name="outgoing-document-conversation" :maxWidth="'3xl'" focusable>
    <div class="h-[600px]" x-data="conversation" @open-modal.window="if($event.detail.name === 'outgoing-document-conversation'){
        fetch_conversation($event.detail.trackingCode);
        show=true;
    }"
    >
