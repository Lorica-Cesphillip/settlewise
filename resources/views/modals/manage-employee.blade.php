            ...
            <div x-cloak x-show="formStep === 1">
                ...
                <div class = "block columns-2">
                    <div>
                        ...
                        <x-text-input x-model="email" id="email" class="block mt-1 w-full" type="email"
                            name="email" :value="old('email')" autofocus autocomplete="off"
                            placeholder="Enter Their Personal Email" />
                ...
                <div class = "border border-black rounded-xl">
                    <div class="p-4 columns-2">
                        <div>
                            ...
                            <p class="font-light">Birthdate: <span class="font-bold underline"
                                    x-text="birthdate"></span></p>
                            ...
                            <p class="font-light">Position: <span class="font-bold underline"
                                    x-text="position"></span></p>
                        </div>
                        <div>
                            <div
