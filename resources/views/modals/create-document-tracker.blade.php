        ...
        <form x-cloak x-data="{ formStep: 1, receiver: '', document_type: '', urgent: false, division: '', others: '', confidential: '', subject: '', document: '', requested: 'false', request_type: '', others: '', request_type: '', requested_document: '', request_details: '', purpose: '' }" class = "space-y-2" action="{{route('outgoing.store')}}" method = "POST">
            ...
            <div x-cloak x-show="formStep === 1">
                ...
                <div class = "w-full inline-flex gap-4">
                    ...
                    <div>
                        ...
                        <input class = "rounded-md w-6 h-6 items-center justify-items-center" id="urgent" name="urgent" type="checkbox"/>
                    </div>
                </div>
                ...
                <div class = "inline-flex gap-4">
                    ...
                    <div>
                        ...
                        <input class = "rounded-md w-6 h-6 items-center justify-items-center" id="confidential" name="confidential" type="checkbox"/>
                    </div>
                </div>

                <div>
                    <x-input-label for="subject" :value="__('Subject *')"/>
                    <x-text-input x-model="subject" id="subject" class="block mt-1 w-full" type="text" name="subject" :value="old('subject')" autofocus autocomplete="off"/>
                    <x-input-error :messages="$errors->get('subject')" class="mt-2" />
                </div>

                <div class = "py-4 w-full justify-between inline-flex">
                    <div class = "inline-flex">
                        <div class = "w-12 h-12 bg-gray-200 rounded-full place-self-center">
                    ...
                    <div class = "justify-end items-end">
                        <label for="document"  class = "flex bg-blue-900 hover:bg-blue-950 text-white text-base px-5 py-2 outline-none rounded w-max cursor-pointer mx-auto">Upload
            ...
            <div x-cloak x-show="formStep === 2">
                ...
                <div class = "inline-flex gap-3 w-full justify-between">
                    ...
                    <div>
                        <x-input-label for="others" :value="__('Others (please specify)')"/>
                        <x-text-input x-model="others" id="others" class="block mt-1 w-[420px] bg-gray-100" type="text" name="others" :value="old('address')" autofocus autocomplete="off" disabled/>
                        <x-input-error :messages="$errors->get('others')" class="mt-2" />
                    </div>
                </div>
                ...
                <div class = "w-full inline-flex gap-3 justify-between">
                    ...
                    <div>
                        ...
                        <x-text-input x-model="purpose" id="purpose" class="block mt-1 w-[420px] bg-gray-100" type="text" name="purpose" :value="old('purpose')" autofocus autocomplete="off" disabled/>
                ...
                <div>
                    ...
                    <x-text-input x-model="request_details" id="request_details" class="block mt-1 w-full bg-gray-100" type="text" name="request_details" :value="old('request_details')" autofocus autocomplete="off" disabled/>
            ...
            <div x-cloak x-show="formStep === 3">
                ...
                <div class = "border border-black rounded-lg p-8">
                    ...
                    <p class = "font-light">Requested Document: <span class = "font-bold" x-text="document_requested"></span></p>
            ...
            <div class = "w-full justify-between inline-flex pt-5 gap-4">
                ...
                <button x-cloak x-show="formStep < 3" @click="formStep += 1" type="button" class = "p-4 bg-[#0d5dba] rounded-lg flex-col justify-center items-center gap-2.5 flex text-white tracking-widest hover:bg-blue-700 focus:ng-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                ...
                <div x-cloak x-show="formStep === 3">
                    <input type="checkbox" id="confirmation" name="confirmation" class = "rounded-sm"/>
                    <label for="confirmation">By clicking, you indicate that the Document Details are correct.</label>
                </div>
