...
<body>
    <!-- View Document Modal -->
    <x-modal name="view-document" class="modal fade" id="viewDocumentModal" tabindex="-1" aria-labelledby="viewDocumentLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered"> 
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div>
                        <button type="button" class="btn btn-active" id="viewDocumentBtn" data-bs-toggle="modal" data-bs-target="#documentPreviewModal">View Document</button>
                        <button type="button" class="btn btn-active" id="referSomeoneBtn" data-bs-toggle="modal" data-bs-target="#referSomeoneModal">Refer Someone</button>
                        <button type="button" class="btn btn-active" id="openChatBtn" data-bs-toggle="modal" data-bs-target="#chatModal">Open Chat</button>
                        <button type="button" class="btn btn-active" id="postAnnouncementBtn" data-bs-toggle="modal" data-bs-target="#postAnnouncementModal">Post Announcement</button>
                    </div>
                    <div class="request-acceptance">
                        <label>Accept Request?</label>
                        <div class="btn-group">
                            <button type="button" class="btn btn-disabled" id="rejectRequestBtn" data-bs-toggle="modal" data-bs-target="#rejectRequestModal">Reject</button>
                            <button type="button" class="btn btn-disabled" id="acceptRequestBtn" data-bs-toggle="modal" data-bs-target="#acceptRequestModal">Accept</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Document Preview -->
    <x-modal name="document-preview" class="modal fade" id="documentPreviewModal" tabindex="-1" aria-labelledby="documentPreviewLabel" aria-hidden="true">
