...
<body>
    ...
    <script>
        ...
        viewDocumentModal.addEventListener('show.bs.modal', function (event) {
            ...
            const trackingCode = button.getAttribute('data-id');

            const exampleData = {
                trackingCode: trackingCode,
                documentType: 'Office Order',
                subject: 'Lorem ipsum dolor sit amet',
                remarks: 'Remarks about the document',
                transmitter: 'Juan Dela Cruz',
                division: 'Administrative Division',
                dateTransmitted: '2025-01-05 13:00:00',
                status: 'Pending'
            };

            document.getElementById('modal-tracking-code').innerText = exampleData.trackingCode;
            document.getElementById('modal-document-type').innerText = exampleData.documentType;
            document.getElementById('modal-subject').innerText = exampleData.subject;
            document.getElementById('modal-remarks').innerText = exampleData.remarks;
            document.getElementById('modal-transmitter').innerText = exampleData.transmitter;
            document.getElementById('modal-division').innerText = exampleData.division;
            document.getElementById('modal-date-transmitted').innerText = exampleData.dateTransmitted;
            document.getElementById('modal-status').innerText = exampleData.status;
        });
    </script>
</body>