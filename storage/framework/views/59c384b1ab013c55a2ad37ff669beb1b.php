...
<?php endif; ?>
        <!--Pagination-->
        <div class="h-9 left-[626px] top-[700px] absolute justify-center items-center gap-1 inline-flex">
            <?php echo e($aphso_employees->links()); ?>

        </div>
        <!--DataTable-->
        <div class="w-[1489px] h-[784px] left-0 top-[168px] absolute">
            <table class = "table-fixed">
                <thead>
                    <tr>
                        <th class = "p-1 justify-start border-b-2 w-[173px] h-[45px]">Employee Id</th>
                        <th class = "p-1 justify-start border-b-2 w-[200px] h-[45px]">Employee Name</th>
                        <th class = "p-1 justify-start border-b-2 w-[200px] h-[45px]">Division</th>
                        <th class = "p-1 justify-start border-b-2 w-[200px] h-[45px]">Position</th>
                        <th class = "p-1 justify-start border-b-2 w-[200px] h-[45px]">Contact Number</th>
                        <th class = "p-1 justify-start border-b-2 w-[200px] h-[45px]">Email</th>
                        <th class = "p-1 justify-start border-b-2 w-[138px] h-[45px]">Status</th>
                        <th class = "p-1 justify-start border-b-2 w-[169px] h-[45px]">Action</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td class = "p-1 justify-start border-b-2 w-[173px] h-[50px]"><?php echo e($employee->divisions->abbreviation); ?>-<?php echo e(str_pad($employee->employee_number, 4, '0', STR_PAD_LEFT)); ?></td>
                        <td class = "p-1 justify-start border-b-2 w-[200px] h-[50px]"><?php echo e($employee->fname); ?> <?php echo e($employee->mname); ?> <?php echo e($employee->lname); ?></td>
                        <td class = "p-1 justify-start border-b-2 w-[200px] h-[50px]"><?php echo e($employee->divisions->division_name); ?></td>
                        <td class = "p-1 justify-start border-b-2 w-[200px] h-[50px]"><?php echo e($employee->position); ?></td>
                        <td class = "p-1 justify-start border-b-2 w-[200px] h-[50px]"><?php echo e($employee->contact_nos); ?></td>
                        <td class = "p-1 justify-start border-b-2 w-[200px] h-[50px]"><?php echo e($employee->email); ?></td>
                        <td class = "p-1 justify-center border-b-2 w-[138px] h-[50px]">
                            <div class="h-6 px-3 py-0.5 bg-[#ffece5] rounded-xl flex-col justify-center items-center gap-2 inline-flex">
                                <div class="justify-center items-center gap-0.5 inline-flex">
                                    <div class="text-center text-[#ad3306] text-sm font-medium leading-tight"><?php echo e($employee->emp_status == 1 ? 'In Service' : 'Archived'); ?></div>
                                </div>
                            </div>
                        </td>
        ...
        <!--Sub_heading-->
        <div class="w-[1486px] h-14 left-[3px] top-[94px] absolute">
            <div class="h-14 left-[1151px] top-0 absolute flex-col justify-start items-start inline-flex">
                <!--Add New Employee Button-->
                <div class="px-6 py-4 bg-[#0d5dba] rounded-lg flex-col justify-center items-center gap-2.5 flex">
                    <div class="justify-center items-center gap-2 inline-flex">
                        <div class="text-center text-white text-base font-semibold  leading-normal">Add New Employee</div>
                    </div>
                </div>
            </div>
            <div class="h-14 left-[1362px] top-0 absolute flex-col justify-start items-start inline-flex">
                <div class="p-4 bg-[#001633] rounded-lg flex-col justify-center items-center gap-2.5 flex">
                    <div class="justify-center items-center gap-2 inline-flex">
                        ...
                        <div class="text-center text-white text-base font-semibold  leading-normal">
                            Refresh</div>
                    </div>
                </div>
            </div>
            <!--Search Bar-->
            <div class="w-[515px] h-14 left-0 top-0 absolute">
                <div class="w-[375px] h-14 left-0 top-0 absolute flex-col justify-start items-start gap-2 inline-flex">
                    <div class="self-stretch h-14 flex-col justify-start items-start gap-1 flex">
                        <div
                            class="self-stretch h-14 p-4 bg-white rounded-md border border-[#d0d4dd] justify-start items-center gap-3 inline-flex">
                            <div class="grow shrink basis-0 h-5 justify-start items-center gap-2 flex">
                                <div class="w-5 h-5 relative">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="Icon-left">
                                        <path id="icon" fill-rule="evenodd" clip-rule="evenodd" d="M9.16675 1.66675C5.02461 1.66675 1.66675 5.02461 1.66675 9.16675C1.66675 13.3089 5.02461 16.6667 9.16675 16.6667C10.9376 16.6667 12.5651 16.053 13.8482 15.0267L16.9108 18.0893C17.2363 18.4148 17.7639 18.4148 18.0893 18.0893C18.4148 17.7639 18.4148 17.2363 18.0893 16.9108L15.0267 13.8482C16.053 12.5651 16.6667 10.9376 16.6667 9.16675C16.6667 5.02461 13.3089 1.66675 9.16675 1.66675ZM3.33341 9.16675C3.33341 5.94509 5.94509 3.33341 9.16675 3.33341C12.3884 3.33341 15.0001 5.94509 15.0001 9.16675C15.0001 12.3884 12.3884 15.0001 9.16675 15.0001C5.94509 15.0001 3.33341 12.3884 3.33341 9.16675Z" fill="#667185"/>
                                        </g>
                                    </svg>
                                </div>
                ...
                <div class="h-14 left-[396px] top-0 absolute flex-col justify-start items-start inline-flex">
                    <div class="p-4 bg-[#0d5dba] rounded-lg flex-col justify-center items-start gap-2.5 flex">
                        <div class="justify-center items-center gap-2 inline-flex">
                            <div class="text-center text-white text-base font-semibold  leading-normal">
                                Search</div>
                            <div class="w-6 h-6 relative">
            ...
            <div class="h-[43px] left-[568px] top-[7px] absolute justify-start items-center gap-2.5 inline-flex">
                <div class="text-black text-sm font-semibold  leading-tight">From</div>
                <div class="w-[175px] h-[43px] relative">
                    <div class="w-[175px] h-[43px] left-0 top-0 absolute bg-white rounded-[5px] border border-[#e7e7e7]"></div>
                    <div class="w-[103px] h-[24.12px] left-[46px] pt-2 absolute text-[#8c8c8c] text-sm font-semibold  leading-tight">Start Date</div>
                    <div class="w-3.5 h-[14.68px] left-[19px] top-[14.68px] absolute"></div>
                    <div class="w-3.5 h-[14.68px] left-[146px] top-[14.68px] absolute"></div>
                </div>
                <div class="text-black text-sm font-semibold  leading-tight">To</div>
                <div class="w-[175px] h-[43px] relative">
                    <div class="w-[175px] h-[43px] left-0 top-0 absolute bg-white rounded-[5px] border border-[#e7e7e7]"></div>
                    <div class="w-[103px] h-[24.12px] left-[46px] pt-2 absolute text-[#8c8c8c] text-sm font-semibold  leading-tight">End Date</div>
                    <div class="w-3.5 h-[14.68px] left-[19px] top-[14.68px] absolute"></div>
                    <div class="w-3.5 h-[14.68px] left-[146px] top-[14.68px] absolute"></div>
                </div>
            </div>
        </div>
        <div class="h-14 left-[1023px] top-[94px] absolute flex-col justify-start items-start inline-flex">
            <div class="p-4 bg-[#0d5dba] rounded-lg flex-col justify-center items-center gap-2.5 flex">
                <div class="justify-center items-center gap-2 inline-flex">
                    <div class="w-6 h-6 relative">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="button-icon">
                    ...
                    <div class="text-center text-white text-base font-semibold  leading-normal">Export
                    </div>
                </div>
            </div>
        </div>
