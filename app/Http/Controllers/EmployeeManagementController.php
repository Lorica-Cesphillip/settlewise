...
class EmployeeManagementController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $division = Divisions::select('division_id')->where('division_name', '=', $request->division_name)->first();
        ...
        User::create([
            ...
            'image_path' => $image,
            'emp_status' => 1,
            'password' => \Illuminate\Support\Facades\Hash::make($request->last_name.$request->division_name.$request->birthdate)
        ]);
